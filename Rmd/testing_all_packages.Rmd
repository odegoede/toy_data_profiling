...
Reports for `fake_ppl`, `ergo`, and `owid_covid` were produced and are in the output directory. 
...
* didn't look too much into this, but there's also a package called validatedb that works on SQL databases; could be more efficient
